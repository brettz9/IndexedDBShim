...
var _BetterSQLiteDatabase = _interopRequireDefault(require("websql/BetterSQLiteDatabase"));
...
function wrappedSQLiteDatabase(name) {
  ...
  return new _BetterSQLiteDatabase.default(name, {
    busyTimeout,
    sqlTrace,
    sqlProfile
  });
...
},{"./CFG":4,"websql/BetterSQLiteDatabase":undefined,"websql/custom":undefined}],23:[function(require,module,exports){
(function (global){
"use strict";
